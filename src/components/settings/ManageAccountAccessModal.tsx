                ...
                {accounts.length === 0 ? (
                  ...
                  accounts.map((account: any) => (
                    ...
                    >
                      ...
                      <div className={`w-5 h-5 rounded border flex items-center justify-center ${selectedAccounts.has(account.id) ? 'bg-accent-600 border-accent-600 text-white' : 'border-gray-300'}`}>
